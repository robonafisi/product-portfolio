...
const ProjectSecond = ({ title, type, img, link }) => {
...
export default function Projects() {
  return (
    <>
      <Head>
        <title>Mo Nafisi Portfolio | Projects Page</title>
        <meta
          name="description"
      ...
      >
        <Layout className="pt-16">
          <AnimatedText
            text="Customer Obsession Fuels Innovation!"
          ...
          <div className="grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0">
            <div className="col-span-12">
              <FeaturedProject
                ...
                title="Patient Companion Application"
                summary="A telephony application to support chronic patients. This application brings a personalised health coach to help with treatment adherence and emotional support."
                img={proj1}
                link="https://youtu.be/5RUyJJ0zwho"
                github="https://github.com/robonafisi/patient-companion"
              />
            </div>
            <div className="col-span-12">
              <FeaturedProject
